...
|------|--------|-----------|-----------|--------|--------|------|------|
| TRYAGAIN | 5x (ada0-ada4) | 18.19TiB | 90.9TB | RAIDZ1 — 1 drive parity | ⚠️ DEGRADED — ada4 resilvering | 59.3TB (65%) | 31.6TB |
...
| ada4 | WD Ultrastar DC HC560 WUH722020BLE6L4 | 9BHXKBKL | 18.19TiB | 5 | ⚠️ Replacing — resilvering |
...
- ⚠️ ada4 (MDD20TGSA25672NAS) — FAULTED, 57 read errors — replaced with WD HC560, resilvering
